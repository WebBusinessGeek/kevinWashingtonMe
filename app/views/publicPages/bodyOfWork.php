<div id="bodyOfWorkPageContainer" class="text-center" ng-controller="bodyOfWorkController">
        ...
        <div class="bodyOfWorkProjectBody">
            <div class="bodyOfWorkProjectInput">
                <div class="bodyOfWorkProjectInputGroup">
                    ...
                    <p>Missing Need Identification</p>
                ...
                <div class="bodyOfWorkProjectInputGroup">
                    ...
                    <p>Branding</p>
                    <p>Business Model / Revenue Generation Strategy</p>
            ...
            <div class="bodyOfWorkProjectViewWorkExamples">
                <button class="btn btn-warning btn-lg" ng-click="showProjectWorkExample('growthValley')">My GrowthValley Work</button>
            </div>
        ...
        <div class="bodyOfWorkProjectBody">
            <div class="bodyOfWorkProjectInput">
                <div class="bodyOfWorkProjectInputGroup">
                    ...
                    <p>Competition Research Process & Tools</p>
                    <p>Content Strategy</p>
                    <p>Search Engine Algorithm Basics</p>
            ...
            <div class="bodyOfWorkProjectViewWorkExamples">
                <button class="btn btn-warning btn-lg" ng-click="showProjectWorkExample('smartHealthyWomen')">My Time with SHW</button>
            </div>
    ...
    <div class="bodyOfWorkProjectContainer">
        ...
        <div class="bodyOfWorkProjectBody">
            ...
            <div class="bodyOfWorkProjectViewWorkExamples">
                <button class="btn btn-warning btn-lg" ng-click="showProjectWorkExample('familyLawCenter')">The FLC Experience</button>
            </div>
