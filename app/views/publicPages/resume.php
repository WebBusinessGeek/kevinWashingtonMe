...
<div class="row text-center" ng-controller="resumeController">
    <div id="resumeIntro" class="col-lg-4 col-md-4">
        <div id="resumeIntroHeader">
            <img class="img-circle img-responsive center-block" src="/assets/selfPictures/smiling_blackWhite.png">
    ...
    <div id="resumeInfoContainer" class="col-lg-8 col-md-8">
        <div id="resumeCustAcq" class="col-lg-6 col-md-6">
            <div>
                <img src="/assets/resumeIcons/custAcqMain.png">
                <h4>Customer Acquisition</h4>
            </div>

            <div class="groupings">
                <div class="custAcqGroup">
                    <img src="/assets/resumeIcons/custAcqSpecialties.png">
                    <h5>Specialties</h5>
                ...
                <div class="custAcqGroup">
                    <img src="/assets/resumeIcons/custAcqEngagement.png">
                ...
                <div class="custAcqGroup">
                    <img src="/assets/resumeIcons/custAcqProcess.png">
        ...
        <div id="resumeWebDev" class="col-lg-6 col-md-6">
            <div>
                <img src="/assets/resumeIcons/webDevMain.png">
                ...
                <div class="groupings">
                    ...
                    <div class="webDevGroup">
                        <img src="/assets/resumeIcons/webDevFrameworks.png">
                        <h5>Frameworks</h5>
                        <p>Laravel 4.*</p>
                        <p>AngularJS 1.*</p>
                        <p>jQuery</p>
                    ...
                    <div id="devMantra" class="webDevGroup">
                        <img src="/assets/resumeIcons/webDevMantra.png">
        ...
        <div id="resumeWorkHistory" class="col-lg-12 col-md-12">
            ...
            <div>
                <img src="/assets/resumeIcons/workExpMain.png">
