...
<nav class="navbar navbar-static-top text-center">
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
            <li><a ng-class="{'activeNavLink': currentUrl== 'tmi'}" class="navLinks" href="/about">Intro</a></li>
...
<!--            <li><a ng-class="{'activeNavLink': currentUrl== 'services'}" class="navLinks" href="/services">Freelancing & Consulting</a></li>-->
